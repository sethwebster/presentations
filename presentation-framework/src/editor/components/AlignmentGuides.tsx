...
export function AlignmentGuides({ draggingElementId, draggingBounds, canvasWidth = 1280, canvasHeight = 720 }: AlignmentGuidesProps) {
  ...
  useEffect(() => {
    ...
    rafRef.current = requestAnimationFrame(() => {
      ...
      // Ensure canvas dimensions are set for center alignment detection
      snapService.setCanvasDimensions(canvasWidth, canvasHeight);
