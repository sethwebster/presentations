...
export function DocumentProperties() {
  ...
  return (
    <div className="flex flex-col gap-6 text-foreground">
      ...
      <div className="space-y-2">
        <Label className={SECTION_HEADING}>Default Slide Transition</Label>
        <select
          value={settings.defaultTransition?.type || 'none'}
          onChange={(e) => {
        ...
        <p className="text-xs text-muted-foreground">
          Applied to all slides unless overridden in slide properties
        </p>
      </div>
