...
export function PropertiesPanel() {
  ...
  return (
    <Panel className="w-[300px] border-l border-border/70">
        ...
        {selectedElement ? (
          <div className="flex flex-col gap-4">
            ...
            {selectedElement.type === 'text' && (
              <div className="rounded-xl border border-border/60 bg-card/80 shadow-sm backdrop-blur">
                ...
                <div className="space-y-6 px-4 py-4">
                  ...
                  <section className="space-y-3">
                    ...
                    <div className="grid grid-cols-4 gap-2">
                      <Toggle
                        ...
                        className="h-9 rounded-lg border border-border/15 text-sm font-semibold"
                      >
                        B
                      </Toggle>
                      <Toggle
                        ...
                        className="h-9 rounded-lg border border-border/15 text-sm italic"
                      >
                        I
                      </Toggle>
                      <Toggle
                        ...
                        className="h-9 rounded-lg border border-border/15 text-sm"
                      >
                  ...
                  <section className="space-y-4">
                    <div className="space-y-3 rounded-lg border border-border/50 bg-muted/40 p-3 shadow-sm">
                      <div className="flex items-center justify-between">
                        <div>
                          <Label className={SECTION_HEADING}>
                            Drop Shadow
...
function PropertyInput({ label, value: numericValue, onChange }: PropertyInputProps) {
