export function Header() {
  return (
    <>
      ...
      >
        <svg width="70" height="70" viewBox="0 0 250 250" style={{ fill: 'var(--lume-primary)', color: 'var(--lume-midnight)', position: 'absolute', top: 0, border: 0, right: 0 }} aria-hidden="true">
