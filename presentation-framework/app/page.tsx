        ...
        <header className="relative px-6 sm:px-12 pt-16 pb-24 max-w-6xl mx-auto">
            ...
            <div className="hidden sm:flex items-center gap-6 text-xs text-[var(--lume-mist)]/70">
              {session?.user ? (
                ...
                <>
                  ...
                  <Link
                    href="/auth/signin"
                    className="px-4 py-2 rounded-full bg-[var(--lume-primary)] text-[var(--lume-midnight)] font-medium hover:bg-[var(--lume-primary)]/90 transition-colors"
                  >
                    Get Started
                  </Link>
                </>
          ...
          <div className="flex flex-col gap-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:items-center">
              ...
              >
                {session?.user ? 'Go to workspace' : 'Sign in to build'}
                <svg
            ...
            <div className="flex gap-4">
              {session?.user ? (
                <Link href="/account/profile" className="hover:text-white transition-colors">
                  {session.user.username || session.user.email?.split('@')[0] || 'Account'}
                </Link>
              ) : (
                <>
                  <Link href="/account" className="hover:text-white transition-colors">
